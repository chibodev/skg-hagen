...
void main() {
  ...
  test('ConfirmationClient successfully retrieves data', () async {
    ...
    expect(confirmation.appointment!.first.occurrence,
        DateTime.parse('2020-04-11'));
    expect(confirmation.appointment!.first.time, '17:00:00');
    expect(confirmation.appointment!.first.endOccurrence,
        DateTime.parse('2020-04-12'));
    ...
    expect(
        confirmation.quote!.first.text.contains(
  ...
  test('ConfirmationClient fails and throws Exception', () async {
    ...
    confirmation = await subject.getConfirmation(httpClient, network,

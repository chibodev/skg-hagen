...
void main() {
  ...
  test('MonthlyScripture gets correct modified text', () {
    subject.oldTestamentText =
        'Psalmen Psalmen Psalmen Psalmen Psalmen Psalmen Psalmen Psalmen';
    expect(subject.getModifiedText(),
        'Psalmen Psalmen Psalmen Psalmen Psalmen Psalmen Psalmen ...');
  });
}
